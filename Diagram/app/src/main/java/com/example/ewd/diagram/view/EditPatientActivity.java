...
public class EditPatientActivity extends AppCompatActivity {
    ...
    EditText medicationsEditTextView;

    @BindView(R.id.recent_procedures_body)
    EditText recentProceduresEditTextView;

    @BindView(R.id.conditions_body)
    EditText conditionsEditTextView;
    ...
    private void populateUI(User user) {
        ...
        TextDrawable drawable = TextDrawable.builder()
                .buildRoundRect( "P",
                        getApplicationContext().getResources().getColor(colors[0]), 150);
        userTypeImageView.setImageDrawable(drawable);

        firstNameEditText.setText(user.getFirstName());
        lastNameEditText.setText(user.getLastName());
        medicationsEditTextView.setText(user.getMedications());
        recentProceduresEditTextView.setText(user.getRecentProcedures());
        conditionsEditTextView.setText(user.getConditions());
    ...
    public void addUserToRemoteAndDb() {
        ...
        String medications = medicationsEditTextView.getText().toString();
        String recentProcedures = recentProceduresEditTextView.getText().toString();
        String conditions = conditionsEditTextView.getText().toString();

        user.setFirstName(firstName);
        user.setLastName(lastName);
        user.setMedications(medications);
        user.setRecentProcedures(recentProcedures);
