 ...
 */
public class TimelineFragment extends Fragment implements PostAdapter.ListItemClickListener,  SwipeRefreshLayout.OnRefreshListener {
     ...
     */
    public static TimelineFragment newInstance(String userId, String sessionKey, String userType) {
    ...
    public void loadDataToRecyclerView() {
        ...
        Call<List<Post>> call = service.getFollowingPosts(token);
